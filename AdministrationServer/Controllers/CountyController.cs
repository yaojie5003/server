...
namespace AdministrationServer.Controllers
{
    ...
    public class CountyController : ApiController
    {
        ...
        [HttpGet, Swashbuckle.Swagger.Annotations.SwaggerResponse(200, "市辖区、县级市、县列表", typeof(List<County>))]
        ...
        [HttpGet, Swashbuckle.Swagger.Annotations.SwaggerResponse(200, "市辖区、县级市、县", typeof(County))]
